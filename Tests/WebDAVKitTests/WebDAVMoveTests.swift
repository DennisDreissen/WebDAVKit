...
@Test
func move_withOverwritePolicy() async throws {
    ...
    #expect(urlRequest.httpMethod == "MOVE")
...
@Test
func move_withFailPolicy() async throws {
    nonisolated(unsafe) var urlRequest: URLRequest!
...
@Test
func move_withCustomHeaders() async throws {
    nonisolated(unsafe) var urlRequest: URLRequest!
...
@Test
func move_returnsInvalidStatusCode() async throws {
    let httpClient = MockWebDAVHTTPClient { request in
        return (
            someData,
            HTTPURLResponse(
